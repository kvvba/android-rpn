...
import com.jakub.rpncalculator.databinding.WidgetConfigBinding
...
class WidgetConfigureActivity : SimpleActivity() {
    ...
    private fun initVariables() {
        ...
        binding.configCalc.formula.text = "15,937\n5"
    ...
    private fun updateTextColor() {
        ...
        val viewIds = intArrayOf(
            ...
            R.id.btn_swap, R.id.btn_drop, R.id.btn_chs, R.id.btn_backspace, R.id.btn_ac,
            R.id.btn_divide, R.id.btn_multiply, R.id.btn_minus, R.id.btn_plus, R.id.btn_decimal,
            R.id.btn_enter
        )
